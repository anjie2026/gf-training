...
var leads = mysqlTable("leads", {
  ...
  audienceType: mysqlEnum("audienceType", ["beginner", "sales", "entrepreneur"]).notNull(),
...
var appRouter = router({
  ...
  leads: router({
    submit: publicProcedure.input(z2.object({
      ...
      contact: z2.string().min(1).max(256),
      audienceType: z2.enum(["beginner", "sales", "entrepreneur"]),
    ...
    list: protectedProcedure.query(async ({ ctx }) => {
      if (ctx.user.role !== "admin") {
        throw new TRPCError3({ code: "FORBIDDEN", message: "\u50C5\u9650\u7BA1\u7406\u54E1\u5B58\u53D6" });
      }
      return getAllLeads();
    }),
